...
if (isset($_POST["send"])) {
    ...
    //Recipients
    $mail->setFrom('yogendrachand444@gmail.com', 'The daily Blogs'); // Sender Email and name
    $mail->addAddress($_POST['email']);     //Add a recipient email  
    $mail->addReplyTo('yogendrachand444@gmail.com', 'The daily Blogs'); // reply to sender email
