<!-- Shows logged-in users own profile -->
<?php
...
<div class="container d-flex">
    ...
    <div class="border-start w-25 p-3">
        <!-- RECENTLY VIEWED BLOGS (STACK) -->
<?php if (!empty($_SESSION['recently_viewed'])): ?>
    <hr>
    <p class="fw-bold h5">Recently Viewed</p>
    <?php foreach ($_SESSION['recently_viewed'] as $viewed): ?>
        <div class="mb-2">
            <a href="read-blog.php?id=<?= $viewed['post_id'] ?>" 
               class="text-decoration-none text-dark">
                <div class="card p-2">
                    <small><?= htmlspecialchars($viewed['title']) ?></small>
                </div>
            </a>
        </div>
    <?php endforeach; ?>
<?php endif; ?>
        ...
        <p class=""><span class="fw-bold"> Date of Birth: </span><?php echo $result['date_of_birth']; ?></p>
