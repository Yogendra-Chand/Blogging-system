<!-- top navigation bar included across all pages -->
<?php
...
?>
<!-- Bootsrap css js linked -->
<link rel="stylesheet" href="style.css">
<link rel="stylesheet" href="bootstrap.min.css">
<script src="bootstrap.bundle.min.js"></script>
<script src="https://kit.fontawesome.com/7419fa8a42.js" crossorigin="anonymous"></script>

<nav class="navbar navbar-expand-sm navbar-light shadow" style="background-color: rgb(205, 79, 184);">
    <div class="container">
        <!-- top navigation text -->
        <a class="navbar-brand fw-bolder" href="index.php">The Daily Blogs</a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            ...
            <ul class="navbar-nav ms-auto gap-lg-5">
                <div class="d-flex justify-content-between align-items-center gap-5">
                    <div>
                        <!-- this one is for the writing content -->
                    ...
                    <div class="">
                        <a href="notification.php" class="text-decoration-none text-dark">
                          <span class="bg-danger text-white p-1 " style="
                                width: 30px;
                                height: 30px; 
                                border-radius: 50%;
                                display: inline-flex;
...
<!-- ajax search  used for searching-->
